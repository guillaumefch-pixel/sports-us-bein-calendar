...
Les réseaux ESPN US ne prouvent jamais une diffusion Disney+ France.
...
def run(args):
    ...
    if len(successes) < 2:
        LOG.warning("UNE SEULE source de diffusion exploitable : exigence multisource non satisfaite")
